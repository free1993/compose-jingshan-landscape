...
[中文](README.md) · [Install](#installation) · [Compatibility](#compatibility) · [Portable prompt](#doubao-and-general-ai-tools) · [Release](#release-package)
...
| Mode | Result |
| --- | --- |
| `jingshan-single` | A standalone vertical 3:5 pictorial photograph |
...
The Skill preserves subject identity, meaningful action, and photographic facts. It does not prove a Chinese aesthetic by applying an ink-wash filter; it rebuilds the image through selection, depth, mist, paper white, and Chinese landscape spatial logic.
...
Download `compose-jingshan-landscape-v1.0.0.zip` from [Releases](https://github.com/free1993/compose-jingshan-landscape/releases). The archive contains exactly one top-level Skill folder with `SKILL.md` at its root.
...
3. Upload a photograph and request a Jingshan single artwork, layered artwork, or before/after output.
...
The standard release archive contains only the installable Skill. It excludes repository documentation, design notes, and Git metadata. Release: [v1.0.0](https://github.com/free1993/compose-jingshan-landscape/releases/tag/v1.0.0).

## Privacy

The repository and release package contain instructions, reference specifications, and the comparison-layout script only. They do not contain source photographs, generated tests, private paths, or generation history. Choose an image-processing provider that matches your privacy requirements.
